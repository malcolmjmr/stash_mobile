...
class Hypothesis {
  ...
  static const apiToken = '6879-zbVCq3wU5_xddQb4BR85liZRfhL4Iqz6CmOYN56o2Eo';
  ...
  Future<Map<String, dynamic>> getGroups() async {
    ...
    final List groupData = convert.jsonDecode(response.body);
    Map<String, dynamic> groupMap = Map();
    for (Map<String, dynamic> group in groupData) {
  ...
  Content normalizeAnnotationFromHypothesisData(
    Map<String, dynamic> data,
      ...
      Content(
        ...
        annotation: AnnotationFields(
          document: data['uri'],
          documentTitle: data['document']['title']?.first,
          target: data['target'],
          note: data['text'],
